...
//  AdminOps - 백업 / 시점 복구
//
//  ★ 여기는 앞의 AdminDB 와 성격이 다르다
//
//    AdminDB 는 DB 에 SQL 을 보내는 일을 한다. C++ 이 직접 한다.
//
...
//
//    binlog 는 MySQL 내부 형식의 이진 파일이라 직접 해석하는 건 현실적이지 않다.
//    그래서 이 파일의 코드는 "그 프로그램들을 올바른 인자로 실행시키는 일" 을 한다.
//
//    C++ 로 옮겨서 좋아지는 점은 명령을 외우지 않아도 된다는 것,
//    그리고 실행 전 안전 확인을 코드로 강제할 수 있다는 것이다.
// ================================================================
