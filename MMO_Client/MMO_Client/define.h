...
enum OBJ_ID {OBJ_PORTAL,OBJ_PLAYER,OBJ_OTHER_PLAYER,OBJ_NPC,OBJ_MONSTER,OBJ_DROP,OBJ_OBJECT,OBJ_END};
enum UI_ID {UI_BUTTON, UI_INVENTORY,UI_QUICKSLOT, UI_HUD,UI_BOX, UI_SHOP, UI_AUCTION, UI_ZONESELECT, UI_END};
...
enum ZONE_ID : int
{
	...
	// 두 맵은 장애물 유무만 다르다 — 서버 Zone_Manager.h 의 ZONE_ID 와 숫자까지 일치할 것.
	ZONE_RAID = 5,        // 장애물 있음
	ZONE_RAID_FLAT = 6,   // 평지(대조군)
