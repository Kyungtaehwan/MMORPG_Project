...
// 부유 몬스터(박쥐형). 오크와 동일한 모션 세트(공격2종/피격/사망/idle/걷기)를 가지며
// 서버가 길찾기 없이 직선으로 추적하는 몬스터. 클라 렌더링/애니메이션 로직은 오크와 동일.
class CMonster_Wing : public CMonster
{
public:
    CMonster_Wing() = default;
    virtual ~CMonster_Wing() = default;
